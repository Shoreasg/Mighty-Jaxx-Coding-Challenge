...
import logo from '../public/mightymetalogo.png'
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="An admin page for Mighty Jaxx" />
        <link rel="icon" href="/favicon.ico" />
      </head>
      <body>
        <header className="bg-[#3077ff]">
          <Image
        ...
        <footer className=' bg-[#3077ff] text-center text-lg font-bold'>
          © Mighty Meta
        </footer>
      </body>
    </html>
